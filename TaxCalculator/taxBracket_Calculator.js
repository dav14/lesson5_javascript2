          ...
          *******************************************************************************/
          ...
          if (status == 1) {
             ...
             if (income <= 19050){
                 ...
                 tax = 9525 * 0.10 + (income - 19050) * 0.12;
                 taxRate = 12;
               }//end of else if
               else if (income <= 165000) {
                 tax = 9525 * 0.10 + (77400 - 19050) * 0.12 + (income - 77400) * 0.22;
                 taxRate = 22;
               } //end of else if
               else if (income <= 315000) {
                 tax = 9525 * 0.10 + (77400 - 19050) * 0.12 +
          ...
          *******************************************************************************/
          ...
          if (status == 3) {
                ...
                if (income <= 13600){
                 ...
                 tax = 9525 * 0.10 + (51800 - 13600) * 0.12 + (income - 51800) * 0.22;
                 taxRate = 22;
               } //end of else if
               else if (income <= 157500) {
